...
supported_models = ["nvidia_io", "nvidia_pn","nvidia_pm",
                    "resnet152_io", "resnet152_pn",
                    "inception_v4_io", "inception_v4_pn",
                    "densenet169_io", "densenet169_pn","custom_model1_io","resnet50model_io","vgg16model_io","xceptionmodel_io","efficientmodel_io"]
...
def train_one_epoch(sess, ops, train_writer, data_input):
    ...
    for batch_idx in range(num_batches):
        if "_io" in MODEL_FILE:
            ...
            #print("in here")
            if "resnet" in MODEL_FILE or "inception" in MODEL_FILE or "densenet" in MODEL_FILE or "vgg16" in MODEL_FILE or "xception" in MODEL_FILE or "efficient" in MODEL_FILE:
